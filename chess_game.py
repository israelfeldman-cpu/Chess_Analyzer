...
class ChessGame:
    ...
    def get_best_move(self, time_limit=60.0):
        ...
        # Cap at 50 seconds to fit within Render's ~70s HTTP timeout
        # (leaving ~20s buffer for network overhead and response processing)
        time_limit = min(time_limit, 50.0)
